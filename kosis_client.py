...
INTENT_MAP: dict[str, dict] = {
    ...
    "저출산": {
        "vw_cd": "MT_TM2_TITLE",
        "keywords": ["저출산", "출산율", "합계출산율", "출생아", "출생아수"],
        "topic_keywords": ["저출산", "출산", "합계출산율", "신생아", "저출생"],
        # "출생" 단독 제거 — 2글자 토큰 매칭이라 "출생아수" 같은 복합어에서 미감지
        # 대신 "출생아"(3글자, substring OK) 추가
    },
    "고령화": {
        "vw_cd": "MT_TM2_TITLE",
    ...
    "주거": {
        "vw_cd": "MT_ZTITLE",
        "keywords": ["주택", "주거", "전세", "주택가격", "주택매매", "부동산"],
        "topic_keywords": ["주택", "주거", "전세", "월세", "아파트", "주택보급"],
        # "주택가격"·"부동산" 추가 — 복합어 토큰 문제("주택가격 추이"에서 미감지) 수정
    },
    "소득": {
        "vw_cd": "MT_ZTITLE",
        "keywords": ["소득", "임금", "가계"],
